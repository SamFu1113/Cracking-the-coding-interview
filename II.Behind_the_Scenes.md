...
Don't let the name fool you,“筛选”面试通常涉及编码和算法问题，并且面试的门槛可能和面对面面试（in-person interview）一样高。如果你不确定面试是否是技术性的，问问你的招聘协调人你的面试官所担任的职位（或面试可能涵盖的范围）。例如，如果是工程师的话，通常会进行技术面试。
