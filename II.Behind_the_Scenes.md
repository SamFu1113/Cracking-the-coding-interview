...
Many companies take advantage of online sync document editors, but there are also some companies that want you to write the code on paper, and then read it back to the interviewer on the phone.Even some interviewers will give you "homework" after hanging up the phone,或者只是让你把写的代码通过电子邮件发给他们。
