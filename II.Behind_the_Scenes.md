...
If the HC recommends a complimentary offer, your package will be submitted to the Workplace Remuneration Committee,然后再提交给执行管理委员会。由于存在许多阶段和委员会，因此返回决策可能需要数周时间。
