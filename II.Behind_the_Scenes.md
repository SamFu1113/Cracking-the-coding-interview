...
Amazon is more prone to experimentation in its hiring process than other companies.The process described here is a typical interview experience,但是由于 Amazon 的试验，它不一定是通用的。
