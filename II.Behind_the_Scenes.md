...
In this question, Microsoft 希望看到你对技术充满热情。一个很好的回答可能是：“从我记事起，我就一直在使用 Microsoft 的软件，我对 Microsoft 如何创造出一款普遍优秀的产品印象深刻。例如，我最近一直在使用 Visual Studio 学习游戏编程，它的 APl 非常出色”。请注意，这样的答案显示了对技术的热情！
