...
Don't let the name fool you. "Screening" interviews often involve coding and algorithm questions and the bar for an interview can be as high as an in-person interview. If you are not sure if the interview is technical,问问你的招聘协调人你的面试官所担任的职位（或面试可能涵盖的范围）。例如，如果是工程师的话，通常会进行技术面试。
