...
Amazon's hiring process usually starts with a video call and candidates are interviewed by a specific team. For a short period of time, candidates may have two or more interviews,This either indicates that one of their interviewers was not persuaded, or that they were considered for a different team or pool.在更不寻常的情况下，例如，当一个求职者在公司当地或最近参加过另一个职位的面试时，他可能只需要做一次电话面试。
