...
During the on-site interview, you will interview with four to six interviewers during the interview, and one of them is the lunch interviewer.每个面试官的反馈对其他面试官是保密的，所以你可以放心，每次面试开始，面试官对你的印象都是空白的。你的午餐面试官不会提交反馈，所以这是一个问诚实问题的好机会。
