...
Amazon places great emphasis on scaling the system. Therefore, make sure you are prepared for scalability issues.要回答这些问题，你并不一定需要有分布式系统方面的背景。请参阅我们在系统设计和可扩展性一章中的建议。
