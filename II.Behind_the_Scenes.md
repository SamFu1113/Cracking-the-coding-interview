...
When you finish interviewing a team, you might talk to a hiring manager(often referred to as "as app" which is the abbreviation of "as appropriate"). If this is the case, that's a good sign!This most likely means that you passed an interview with a particular team.现在就看招聘经理的决定了。
