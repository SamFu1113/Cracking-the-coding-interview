...
When you finish interviewing a team, you might talk to a hiring manager(often referred to as "as app" which is the abbreviation of "as appropriate"). If this is the case, that's a good sign! BecauseIt most likely means that you passed an interview with a particular team. Now it's up to the hiring manager to decide.
