...
&nbsp;&nbsp;&nbsp;&nbsp;Another reason for the emergence of knowledge of data structures and algorithms is it's hard to ask problem-solving problems that don't involve them. It turns out that绝大多数解决问题的问题涉及其中一些基础知识。当足够多的应聘者了解这些基本知识时，很容易进入一种向他们提问的模式。
