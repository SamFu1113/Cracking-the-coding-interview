...
The interviewer will think that basic computer science knowledge is actually useful. You hae to keep in mid that situations that require knowledge of trees, graphs, lists, sorting, and other things will certainly arise from time to time. If so,掌握书本的知识真的很有必要。
