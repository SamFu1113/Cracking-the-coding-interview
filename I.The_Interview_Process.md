...
Wouldn't it be possible to selectively learn as needed when faced with a problem? Of, course. But if you don't know the existence of binary search trees, it's hard to know when to use it when you need it. If you know it exists, 那么你具有了基本的概念。
