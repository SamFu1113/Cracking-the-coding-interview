...
Wouldn't it be possible to selectively learn as needed when faced with a problem? Of, course, but if you don't know the existence of binary search trees,你就很难在需要的时候知道应该去使用它。如果你知道它的存在，那么你具有了基本的概念。
