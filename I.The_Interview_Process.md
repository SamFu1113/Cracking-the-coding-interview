...
The interviewer will think that basic computer science knowledge is actually useful. Keep in mid that, 需要用到树、图、列表、排序和其他知识的情况隔段时间肯定会出现。如果真是这样的话，掌握书本的知识真的很有必要。
